...
cd /var/www/html
wget https://www.dropbox.com/s/iiigwl0tthdcri5/v20.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/jamesscripts/v20/main/Arquivos/bancov20.sql > /dev/null 2>&1
sleep 1
